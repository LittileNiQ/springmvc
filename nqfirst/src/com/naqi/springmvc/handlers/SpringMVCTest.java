...
import com.naqi.springmvc.entities.User;

//@SessionAttributes(value={"user"},types={String.class})
@RequestMapping("/springmvc")//请求域
@Controller
public class SpringMVCTest{
   ...
   @ModelAttribute
	public void getUser(@RequestParam(value="id",required=false) Integer id, 
		...
		if(id != null){
			//模拟从数据库中获取对象
			User user = new User(1, "Tom", "123456", "@naqi.com", 12);
...
//   }
   ...
   @RequestMapping("/testSessionAttributes")
	public String testSessionAttributes(Map<String, Object> map){
		User user = new User("Tom", "123456", "naqi.com", 15);
		map.put("user", user);
		map.put("school", "naqi");
		return SUCCESS;
	}
...
//		return SUCCESS;
    ...
    */
   @RequestMapping(value="testParamsAndHeaders",params={"username","age!=11"},headers={})
    ...
    * 2）。方法处：提供进一步的组分映射信息。相对于类定义处的URL。
    * 若类定义除未标注@RequestMapping，则方法处标记的URL相对于web应用的根目录。
    * 
    * @return
    */
